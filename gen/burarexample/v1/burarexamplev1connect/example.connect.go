...
package burarexamplev1connect

import (
	connect "connectrpc.com/connect"
	context "context"
	errors "errors"
	v1 "github.com/yolocs/bufar/gen/burarexample/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	TalkerServiceName = "burarexample.v1.TalkerService"
)
...
const (
	...
	TalkerServiceHelloProcedure = "/burarexample.v1.TalkerService/Hello"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	talkerServiceServiceDescriptor     = v1.File_burarexample_v1_example_proto.Services().ByName("TalkerService")
	talkerServiceHelloMethodDescriptor = talkerServiceServiceDescriptor.Methods().ByName("Hello")
)

// TalkerServiceClient is a client for the burarexample.v1.TalkerService service.
...
// NewTalkerServiceClient constructs a client for the burarexample.v1.TalkerService service. By
...
// Hello calls burarexample.v1.TalkerService.Hello.
...
// TalkerServiceHandler is an implementation of the burarexample.v1.TalkerService service.
...
func NewTalkerServiceHandler(svc TalkerServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/burarexample.v1.TalkerService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedTalkerServiceHandler) Hello(context.Context, *connect.Request[v1.HelloRequest]) (*connect.Response[v1.HelloResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("burarexample.v1.TalkerService.Hello is not implemented"))
}
